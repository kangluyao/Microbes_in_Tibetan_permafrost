...
sub_input_table <- file.path(wd_fun, "metabolic/METABOLIC_70_layer_rare/METABOLIC_70_sub/METABOLIC_Figures_Input/Metabolic_Sankey_diagram_input_rare.txt")
pl_input_table <- file.path(wd_fun, "metabolic/METABOLIC_70_layer_rare/METABOLIC_70_pl/METABOLIC_Figures_Input/Metabolic_Sankey_diagram_input_rare.txt")
```
