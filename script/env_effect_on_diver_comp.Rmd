...
sel_env <- c("MAT", "AI", "Moisture",	"pH",	"Clay",	"Silt",	
...
library(Hmisc)
envs <- metadata[, c("AI", "MAT", "Clay", "Silt", "Sand", "Moisture", "pH",  "NH4_N", "NO3_N", "DON",       "SOC", "DOC", "LCP1", "LCP2", "RCP")]
...
Based on the variable clustering results, we retain Clay, Silt, AI, NH<sub>4</sub><sup>+</sup>-N, Moisture, NO<sub>3</sub><sup>-</sup>-N, pH, MAT, LCP1, and RCP for the partial mantel test. 
...
partial.mantel.fun <- function(phylo) {
  ...
  df <- NULL
  vars <- c("MAT", "AI", "Moisture",	"pH",	"Clay",	"Silt",	 
