...
library(Hmisc)
envs <- metadata[, c("AI", "MAT", "NDVI", "SR", "HF", "Clay", "Silt", "Moisture", "pH",  "NH4_N", "NO3_N", "DON", "SOC", "DOC", "LCP1", "LCP2", "RCP")]
...
env_paired_wilcox_test <- meta_dat %>% as.tibble() %>% dplyr::select(c("Layer", env_vars)) %>%
...
vars <- c("MAT", "AI", "SR", "NDVI", "HF", "Moisture",	"pH",	"Clay",	"Silt",	 
            "NH4_N",	"NO3_N", "LCP1", "RCP")
