...
```{r, fig.align='center', fig.height=12.8, fig.width=12.9}
...
CO2_flux_var <- "Cumulative_CO2_flux_5_soil"
carbon_vars <- colnames(co2_df)[-1]

plot_cor_df(data = co2_df, y.name = CO2_flux_var, x.names = carbon_vars, ncol = 5,
            point.color = "#D14285")
```


```{r, fig.align='center', fig.height=4.8, fig.width=8.9}
...
ch4_flux_var <- "CH4"
ch4_vars <- colnames(ch4_df)[-1]

plot_cor_df(data = ch4_df, y.name = ch4_flux_var, x.names = ch4_vars, ncol = 3,
            point.color = "#D14285")
